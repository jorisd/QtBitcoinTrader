...
{
	if(ruleBtc==-5.0)return julyTr("CANCEL","Cancel");
...
QString RuleHolder::getBitcoinsString()
{
	...
	if(ruleBtc==-2.0)return julyTr("SELL_ALL_BTC","Sell Half my BTC");
	if(ruleBtc==-3.0)return julyTr("SELL_ALL_BTC","Spend All my Funds");
	if(ruleBtc==-4.0)return julyTr("SELL_ALL_BTC","Spend Half my Funds");
	if(ruleBtc==-5.0)return julyTr("SELL_ALL_BTC","All Orders");
...
QString RuleHolder::getPriceText()
{
	...
	if(rulePrice==-1.0)return julyTr("SAME_AS_RULE","Market Last");
	if(rulePrice==-2.0)return julyTr("SAME_AS_RULE","Market Buy");
	if(rulePrice==-3.0)return julyTr("SAME_AS_RULE","Market Sell");
	if(rulePrice==-4.0)return julyTr("SAME_AS_RULE","Market High");
	if(rulePrice==-5.0)return julyTr("SAME_AS_RULE","Market Low");
	if(rulePrice==-6.0)return julyTr("SAME_AS_RULE","Orders Last Buy");
	if(rulePrice==-7.0)return julyTr("SAME_AS_RULE","Orders Last Sell");
