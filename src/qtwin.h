...
{
public:
    static bool enableBlurBehindWindow(QWidget *widget, bool enable = true, bool skipCheck=false);
    static bool extendFrameIntoClientArea(QWidget *widget, bool skipCheck=false,
